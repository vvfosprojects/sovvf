...
namespace SO115App.Persistence.Oracle.Classi
{
    public class ORAPartenze
    {
        ...
        /// </summary>
        public decimal DATA_INTERVENTO { get; set; }
        ...
        /// </summary>
        public decimal DATA_ASSEGNAZIONE { get; set; }

        /// <summary>
        ///   /// CAMPO CONFERMATA DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal CONFERMATA { get; set; }

        /// <summary>
        ///   /// CAMPO CAPO_PARTENZA DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal CAPO_PARTENZA { get; set; }

        /// <summary>
        ///   /// CAMPO AUTISTA DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal AUTISTA { get; set; }
        ...
        /// </summary>
        public decimal DATA_ULT_AGG { get; set; }

        /// <summary>
        ///   /// CAMPO DATA_ULT_AGG DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal DATA_PARTENZA_LUOGO { get; set; }

        /// <summary>
        ///   /// CAMPO DATA_SOSTITUZIONE DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal DATA_SOSTITUZIONE { get; set; }

        /// <summary>
        ///   /// CAMPO DATA_INS DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal DATA_INS { get; set; }

        /// <summary>
        ///   /// CAMPO TERMINALE DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal TERMINALE { get; set; }

        /// <summary>
        ///   /// CAMPO TRIGGER_OFF DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal TRIGGER_OFF { get; set; }

        /// <summary>
        ///   /// CAMPO FLAG_ANNULLA DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal FLAG_ANNULLA { get; set; }

        /// <summary>
        ///   /// CAMPO FLAG_AUTOMEZZI DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal FLAG_AUTOMEZZI { get; set; }

        /// <summary>
        ///   /// CAMPO ID_PARTENZE_INIZIALI DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal ID_PARTENZE_INIZIALI { get; set; }

        /// <summary>
        ///   /// CAMPO ID_PARTENZE_INTERMEDIE DELLA TABELLA PARTENZE ///
        /// </summary>
        public decimal ID_PARTENZE_INTERMEDIE { get; set; }
