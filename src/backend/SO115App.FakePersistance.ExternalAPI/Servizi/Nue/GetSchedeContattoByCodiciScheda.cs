...
{
    /// <summary>
    ///   Classe che restituisce tutte le schede contatto indicate nell'array di codici schede in input
    /// </summary>
    public class GetSchedeContattoByCodiciScheda : IGetSchedeContattoByCodiciScheda
    {
        private readonly GetSchedeMethods _getSchedeMethods;

        public GetSchedeContattoByCodiciScheda(GetSchedeMethods getSchedeMethods)
        {
