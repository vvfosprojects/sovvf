...
namespace Modello.Test.Classi.Soccorso
{
    ...
    public class TestEventi
    {
        ...
        //{
        //    Assert.That(
        //        () => new VaInFuoriServizio(this.richiesta, " ", DateTime.Now, "Fonte", "motivazione", 0),
        //        Throws.ArgumentException);
        //}
        ...
        //{
        //    Assert.That(
        //        () => new VaInFuoriServizio(this.richiesta, "M1", new DateTime(), "Fonte", "motivazione", 0),
        //        Throws.TypeOf<ArgumentOutOfRangeException>());
        //}
        ...
        //{
        //    Assert.That(
        //        () => new VaInFuoriServizio(this.richiesta, "M1", DateTime.Now, " ", "motivazione", 0),
        //        Throws.ArgumentException);
        //}
        ...
        //{
        //    Assert.That(
        //        () => new VaInFuoriServizio(this.richiesta, "M1", DateTime.Now, "Fonte", " ", 0),
        //        Throws.ArgumentException);
        //}
        ...
        //{
        //    var now = DateTime.Now;
        //    var evento = new VaInFuoriServizio(this.richiesta, "M1", now, "Fonte", "motivazione", 0);
        ...
        //{
        //    var now = DateTime.Now;
        //    var evento = new UscitaPartenza(this.richiesta, "M1", now, "Fonte", 0);
        ...
        //{
        //    Assert.That(
        //        () => new UscitaPartenza(this.richiesta, " ", DateTime.Now, "Fonte", 0),
        //        Throws.ArgumentException);
        //}
        ...
        //{
        //    Assert.That(
        //        () => new UscitaPartenza(this.richiesta, "M1", new DateTime(), "Fonte", 0),
        //        Throws.TypeOf<ArgumentOutOfRangeException>());
        //}
        ...
        //{
        //    Assert.That(
        //        () => new UscitaPartenza(this.richiesta, "M1", DateTime.Now, " ", 0),
        //        Throws.ArgumentException);
        //}
