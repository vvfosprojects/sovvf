...
#warning Non è chiaro se Telefonata debba diventare una classe astratta e avere come derivate TelefonataEsterna, TelefonataNUE, ecc.
    public class Telefonata : Segnalazione
    {
        ...
        /// <summary>
        /// E' la ragione sociale del chiamante. Ad es.: Carabinieri, CC,
        /// Polizia Municipale, 118, ecc.
        /// </summary>
        public string RagioneSociale { get; set; }

        /// <summary>
        /// E' il codice della scheda contatto legata alla telefonata. In linea
        /// di principio, una scheda contatto potrebbe non avere seguito e non generare un'istanza
        /// di telefonata, anche se questa possibilità indica una potenziale anomalia di
        /// processo.
        /// </summary>
