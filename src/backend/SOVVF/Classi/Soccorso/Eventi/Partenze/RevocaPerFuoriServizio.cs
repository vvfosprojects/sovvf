//-----------------------------------------------------------------------
// <copyright file="RevocaPerFuoriServizio.cs" company="CNVVF">
...
namespace Modello.Classi.Soccorso.Eventi.Partenze
{
    ...
    ///   <see cref="RichiestaAssistenza" /> a causa di un fuori servizio.
    /// </summary>
    public class RevocaPerFuoriServizio : Revoca
    {
        /// <summary>
