...
namespace Modello.Servizi.CQRS.Commands.GestioneSoccorso.SelezioneRisorse
{
    ...
    /// </remarks>
    public class TestAndSetSelezioneDisponibilitaSquadra : ITestAndSetSelezioneDisponibilitaSquadra
    {
        /// <summary>
        ...
        {
            var selezioneRisorsa = new SelezioneRisorsa();
            var selezioneSquadraCommandHandler = new SelezionaSquadraCommandHandler();
            var selezioneSquadraCommand = new SelezionaSquadraCommand();
            try
            {
                selezioneSquadraCommandHandler.Handle(selezioneSquadraCommand);
            }
            catch (Exception e)
            {
            }
