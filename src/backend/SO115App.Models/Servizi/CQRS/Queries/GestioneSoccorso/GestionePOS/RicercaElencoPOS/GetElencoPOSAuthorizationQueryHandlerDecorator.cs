//-----------------------------------------------------------------------
// <copyright file="GetElencoPOSAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
{
    public class GetElencoPOSAuthorizationQueryHandlerDecorator : IQueryAuthorizer<GetElencoPOSQuery, GetElencoPOSResult>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public GetElencoPOSAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(GetElencoPOSQuery query)
        {
