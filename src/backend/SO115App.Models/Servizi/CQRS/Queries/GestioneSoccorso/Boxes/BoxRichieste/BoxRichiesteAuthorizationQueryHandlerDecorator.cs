//-----------------------------------------------------------------------
// <copyright file="BoxRichiesteAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
namespace SO115App.API.Models.Servizi.CQRS.Queries.GestioneSoccorso.Boxes
{
    public class BoxRichiesteAuthorizationQueryHandlerDecorator : IQueryAuthorizer<BoxRichiesteQuery, BoxRichiesteResult>
    {
        ...
        public BoxRichiesteAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername)
        {
