//-----------------------------------------------------------------------
// <copyright file="BoxPersonaleAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
namespace SO115App.API.Models.Servizi.CQRS.Queries.GestioneSoccorso.Boxes
{
    public class BoxPersonaleAuthorizationQueryHandlerDecorator : IQueryAuthorizer<BoxPersonaleQuery, BoxPersonaleResult>
    {
        ...
        public BoxPersonaleAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername)
        {
            this._currentUser = currentUser;
            _findUserByUsername = findUserByUsername;
        }

        public IEnumerable<AuthorizationResult> Authorize(BoxPersonaleQuery query)
        {
