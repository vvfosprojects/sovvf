//-----------------------------------------------------------------------
// <copyright file="GetDocByIdAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
{
    public class GetDocByIdAuthorizationQueryHandlerDecorator : IQueryAuthorizer<GetDocByIdQuery, GetDocByIdResult>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public GetDocByIdAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(GetDocByIdQuery query)
        {
