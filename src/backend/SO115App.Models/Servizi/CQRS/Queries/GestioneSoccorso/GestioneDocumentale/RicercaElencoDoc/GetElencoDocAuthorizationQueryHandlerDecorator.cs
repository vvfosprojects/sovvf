//-----------------------------------------------------------------------
// <copyright file="GetElencoDocAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
{
    public class GetElencoDocAuthorizationQueryHandlerDecorator : IQueryAuthorizer<GetElencoDocQuery, GetElencoDocResult>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public GetElencoDocAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(GetElencoDocQuery query)
        {
