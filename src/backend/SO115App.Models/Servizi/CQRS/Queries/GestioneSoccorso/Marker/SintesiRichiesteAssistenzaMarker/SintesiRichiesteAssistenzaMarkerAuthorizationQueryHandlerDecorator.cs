//-----------------------------------------------------------------------
// <copyright file="SintesiRichiesteAssistenzaMarkerAuthorizationQueryHandlerDecorator.cs" company="CNVVF">
...
namespace SO115App.API.Models.AOP.Authorization
{
    public class SintesiRichiesteAssistenzaMarkerAuthorizationQueryHandlerDecorator : IQueryAuthorizer<SintesiRichiesteAssistenzaMarkerQuery, SintesiRichiesteAssistenzaMarkerResult>
    {
        ...
        public SintesiRichiesteAssistenzaMarkerAuthorizationQueryHandlerDecorator(IPrincipal currentUser, IFindUserByUsername findUserByUsername)
        {
