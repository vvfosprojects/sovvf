...
{
    public class DeleteBlockAuthorization : ICommandAuthorizer<DeleteBlockCommand>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public DeleteBlockAuthorization(
        ...
        public IEnumerable<AuthorizationResult> Authorize(DeleteBlockCommand command)
        {
