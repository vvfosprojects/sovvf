...
namespace SO115App.Models.Servizi.CQRS.Commands.GestioneEmergenza.UpdateEmergenza
{
    public class InsertEmergenzaNotifier : ICommandNotifier<UpdateEmergenzaCommand>
    {
        ...
        public void Notify(UpdateEmergenzaCommand command)
        {
            ...
            var messaggio = $"E' stata aggiornata l'emergenza codice {command.InfoEmergenza.CodEmergenza}. Coordinate: x:{command.InfoEmergenza.Localita.Coordinate.Longitudine} y:{command.InfoEmergenza.Localita.Coordinate.Latitudine}";
