//-----------------------------------------------------------------------
// <copyright file="InsertEmergenzaNotifier.cs" company="CNVVF">
...
{
    public class AnnullaEmergenzaNotifier : ICommandNotifier<AnnullaEmergenzaCommand>
    {
        ...
        public AnnullaEmergenzaNotifier(
        ...
        public void Notify(AnnullaEmergenzaCommand command)
        {
            ...
            var messaggio = $"E' stata annullata l'emergenza codice {command.InfoEmergenza.CodEmergenza}. Coordinate: x:{command.InfoEmergenza.Localita.Coordinate.Longitudine} y:{command.InfoEmergenza.Localita.Coordinate.Latitudine}";
