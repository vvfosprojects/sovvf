//-----------------------------------------------------------------------
// <copyright file="CreazioneCraNotifier.cs" company="CNVVF">
...
{
    public class CreazioneCraNotifier : ICommandNotifier<CreazioneCraCommand>
    {
        ...
        public void Notify(CreazioneCraCommand command)
        {
            ...
            var messaggio = $"E' stato creato un Cra per l'emergenza codice {command.Emergenza.CodEmergenza}. Coordinate: x:{command.Emergenza.Localita.Coordinate.Longitudine} y:{command.Emergenza.Localita.Coordinate.Latitudine}";
            var infoMatrix = new MessageMatrix()
            {
                Messaggio = messaggio,
                CodSede = command.Emergenza.CodComandoRichiedente
            };
