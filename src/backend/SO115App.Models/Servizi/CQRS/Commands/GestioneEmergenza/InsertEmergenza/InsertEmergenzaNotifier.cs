...
{
    public class InsertEmergenzaNotifier : ICommandNotifier<InsertEmergenzaCommand>
    {
        ...
        public void Notify(InsertEmergenzaCommand command)
        {
            ...
            var messaggio = $"E' stata creata l'emergenza codice {command.InfoEmergenza.CodEmergenza}. Coordinate: x:{command.InfoEmergenza.Localita.Coordinate.Longitudine} y:{command.InfoEmergenza.Localita.Coordinate.Latitudine}";
