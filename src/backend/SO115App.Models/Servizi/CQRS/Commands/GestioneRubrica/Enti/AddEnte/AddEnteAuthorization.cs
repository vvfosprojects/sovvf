...
{
    public class AddEnteAuthorization : ICommandAuthorizer<AddEnteCommand>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public AddEnteAuthorization(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(AddEnteCommand command)
        {
