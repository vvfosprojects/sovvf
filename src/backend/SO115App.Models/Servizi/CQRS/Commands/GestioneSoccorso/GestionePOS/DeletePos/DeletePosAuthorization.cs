//-----------------------------------------------------------------------
// <copyright file="DeletePosAuthorization.cs" company="CNVVF">
...
{
    public class DeletePosAuthorization : ICommandAuthorizer<DeletePosCommand>
    {
        ...
        public DeletePosAuthorization(IPrincipal currentUser,
        ...
        public IEnumerable<AuthorizationResult> Authorize(DeletePosCommand command)
        {
