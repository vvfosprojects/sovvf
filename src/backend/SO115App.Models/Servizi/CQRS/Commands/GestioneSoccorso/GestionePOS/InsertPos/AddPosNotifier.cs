...
{
    public class AddPosNotifier : ICommandNotifier<AddPosCommand>
    {
        private readonly INotificationAddPos _sender;

        public AddPosNotifier(INotificationAddPos sender)
        {
            _sender = sender;
        }

        public void Notify(AddPosCommand command)
        {
