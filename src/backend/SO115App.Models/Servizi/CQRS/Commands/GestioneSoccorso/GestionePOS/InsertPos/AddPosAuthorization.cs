//-----------------------------------------------------------------------
// <copyright file="AddPosAuthorization.cs" company="CNVVF">
...
{
    public class AddPosAuthorization : ICommandAuthorizer<AddPosCommand>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public AddPosAuthorization(IPrincipal currentUser,
        ...
        public IEnumerable<AuthorizationResult> Authorize(AddPosCommand command)
        {
