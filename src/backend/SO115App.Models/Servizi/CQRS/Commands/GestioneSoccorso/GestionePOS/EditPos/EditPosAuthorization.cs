//-----------------------------------------------------------------------
// <copyright file="EditPosAuthorization.cs" company="CNVVF">
...
{
    public class EditPosAuthorization : ICommandAuthorizer<EditPosCommand>
    {
        ...
        public EditPosAuthorization(IPrincipal currentUser,
        ...
        public IEnumerable<AuthorizationResult> Authorize(EditPosCommand command)
        {
            ...
            if (_currentUser.Identity.IsAuthenticated)
            {
                ...
                else
                {
                    ...
                    var listaSediInteressate = _getSottoSediByCodSede.Get(new string[1] { command.Pos.CodSede });

                    if (!_isActionFree.Check(TipoOperazione.ModificaPos, user.Id, listaSediInteressate.ToArray(), command.Pos.Id))
