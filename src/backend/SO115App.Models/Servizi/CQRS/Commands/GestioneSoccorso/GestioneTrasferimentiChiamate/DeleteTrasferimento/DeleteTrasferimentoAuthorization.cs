...
{
    public class DeleteTrasferimentoAuthorization : ICommandAuthorizer<DeleteTrasferimentoCommand>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public DeleteTrasferimentoAuthorization(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(DeleteTrasferimentoCommand command)
        {
