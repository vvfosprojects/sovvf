...
{
    public class AddDettaglioTipologiaAuthorization : ICommandAuthorizer<AddDettaglioTipologiaCommand>
    {
        private readonly IPrincipal _currentUser;
        private readonly IFindUserByUsername _findUserByUsername;
        private readonly IGetAutorizzazioni _getAutorizzazioni;

        public AddDettaglioTipologiaAuthorization(IPrincipal currentUser, IFindUserByUsername findUserByUsername, IGetAutorizzazioni getAutorizzazioni)
        {
        ...
        public IEnumerable<AuthorizationResult> Authorize(AddDettaglioTipologiaCommand command)
        {
