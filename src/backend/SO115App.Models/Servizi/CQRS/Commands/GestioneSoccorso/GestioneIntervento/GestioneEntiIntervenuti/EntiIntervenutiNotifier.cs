...
{
    public class EntiIntervenutiNotifier : ICommandNotifier<EntiIntervenutiCommand>
    {
        private readonly INotifyAddEntiIntervenuti _sender;

        public EntiIntervenutiNotifier(INotifyAddEntiIntervenuti sender)
        {
            _sender = sender;
        }

        public void Notify(EntiIntervenutiCommand command)
        {
