//-----------------------------------------------------------------------
// <copyright file="LogBookAuthorization.cs" company="CNVVF">
...
{
    public class LogBookAuthorization : ICommandAuthorizer<LogBookCommand>
    {
        ...
        public LogBookAuthorization(IPrincipal currentUser, IFindUserByUsername findUserByUsername,
