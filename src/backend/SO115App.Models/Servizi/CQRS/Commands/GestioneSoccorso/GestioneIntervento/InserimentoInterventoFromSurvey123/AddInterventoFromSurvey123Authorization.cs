...
{
    public class AddInterventoFromSurvey123Authorization : ICommandAuthorizer<AddInterventoFromSurvey123Command>
    {
        ...
        public AddInterventoFromSurvey123Authorization(IPrincipal currentUser,
