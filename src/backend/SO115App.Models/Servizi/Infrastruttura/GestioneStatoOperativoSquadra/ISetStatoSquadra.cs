...
namespace SO115App.Models.Servizi.Infrastruttura.GestioneStatoOperativoSquadra
{
    ...
    public interface ISetStatoSquadra
    {
        ...
        void SetStato(string codice, string idSquadra, string idRichiesta, string statoSquadra, string codiceSede, string codMezzo, string TurnoSquadra, string turno);
    }
}
