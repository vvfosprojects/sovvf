...
namespace SO115App.Models.Servizi.Infrastruttura.SistemiEsterni.Gac
{
    ...
    /// </summary>
    public interface IGetMezziUtilizzabiliByAreaMappa
    {
        /// <summary>
        ///   Restituisce la lista dei mezzi
        /// </summary>
        /// <param name="areaMappa">Area della mappa nella quale devono ricadere i mezzi in servizio</param>
        /// <returns>una lista mezzi</returns>
        Task<List<Mezzo>> Get(AreaMappa areaMappa);
    }
}
