//-----------------------------------------------------------------------
// <copyright file="IGetSchedeContattoByCodiceSede.cs" company="CNVVF">
...
namespace SO115App.Models.Servizi.Infrastruttura.SistemiEsterni.Nue
{
    ...
    /// </summary>
    public interface IGetSchedeContattoByCodiceSede
    {
        /// <summary>
        ...
        List<SchedaContatto> SchedeContattoFromCodiceSede(string codice);
    }
}
