//-----------------------------------------------------------------------
// <copyright file="IGetSchedeContattoBySpatialArea.cs" company="CNVVF">
...
namespace SO115App.Models.Servizi.Infrastruttura.SistemiEsterni.Nue
{
    ...
    /// </summary>
    public interface IGetSchedeContattoBySpatialArea
    {
        /// <summary>
        ...
        List<SchedaContatto> SchedeContattoBySpatialArea(double lat1, double lon1, double lat2, double lon2);
    }
}
