//-----------------------------------------------------------------------
// <copyright file="IGetSchedeContattoByTipo.cs" company="CNVVF">
...
namespace SO115App.Models.Servizi.Infrastruttura.SistemiEsterni.Nue
{
    ...
    /// </summary>
    public interface IGetSchedeContattoByTipo
    {
        /// <summary>
        ...
        List<SchedaContatto> SchedeContattoFromListTipo(List<string> classificazione, string codiceSede);
    }
}
