...
namespace SO115App.API.Models.Classi.Soccorso.Eventi
{
    ...
    /// </remarks>
    public class AnnullamentoPresaInCarico : Evento
    {
        /// <summary>
        ...
        public AnnullamentoPresaInCarico(RichiestaAssistenza richiesta, DateTime istante, string codiceFonte) : base(richiesta, istante, codiceFonte, "AnnullamentoPresaInCarico")
        {
        }
    }
}
