//-----------------------------------------------------------------------
// <copyright file="TipologiaRichiesta.cs" company="CNVVF">
...
{
    /// <summary>
    ///   Modella una tipologia di richiesta di assistenza
    /// </summary>
    public class TipologiaRichiesta
    {
        ...
        public TipologiaRichiesta(string codice, string descrizione)
        {
