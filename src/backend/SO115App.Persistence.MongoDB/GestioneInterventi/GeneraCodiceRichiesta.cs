...
namespace SO115App.Persistence.MongoDB.GestioneInterventi
{
    public class GeneraCodiceRichiesta : IGeneraCodiceRichiesta
    {
        ...
        public string Genera(string codiceProvincia, int anno)
        {
            ...
            string returnFormatString = string.Format("{0}{1}{2:D5}", codiceProvincia.Split('.')[0], ultimeDueCifreAnno, maxNumero + 1);
        ...
        public string GeneraCodiceChiamata(string codiceProvincia, int anno)
        {
            ...
            string returnString = string.Format("{0}{1}{2}{3}{4:D5}", codiceProvincia.Split('.')[0], giorno, mese, ultimeDueCifreAnno, maxNumero + 1);
            return returnString;
        }
    }
}
