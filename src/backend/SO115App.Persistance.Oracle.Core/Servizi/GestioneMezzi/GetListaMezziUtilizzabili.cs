...
namespace SO115App.Persistence.Oracle.Core.Servizi.GestioneMezzi
{
    public class GetListaMezziUtilizzabili: IGetMezziUtilizzabili
    {
        private readonly IDBContext _dbcontext;

        public GetListaMezziUtilizzabili(IDBContext dbcontext)
        {
