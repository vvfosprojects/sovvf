...
export class SintesiRichiesteServiceFake {
    ...
    getRichieste(idUltimaRichiesta?: string) {
        ...
        this.richieste[3].tipoTerreno = [new TipoTerreno('1', TipoTerrenoEnum.Boschi, 200000), new TipoTerreno('1', TipoTerrenoEnum.Campi, 100000)];
        this.richieste[4].tipoTerreno = [new TipoTerreno('1', TipoTerrenoEnum.Sterpaglie, 200000)];
