...
export function squadraComposizionePreaccoppiatoBusy(stato: StatoSquadra): boolean {
    switch (stato) {
        case StatoSquadra.SulPosto:
            return true;
        case StatoSquadra.InViaggio:
...
export function mezzoComposizionePreaccoppiatoBusy(stato: StatoMezzo): boolean {
    switch (stato) {
        case StatoMezzo.SulPosto:
            return true;
        case StatoMezzo.InUscita:
...
export function checkPreaccoppiatoOccupato(statoMezzo: StatoMezzo, squadreComposizione: SquadraComposizione[]): boolean {
    if (mezzoComposizionePreaccoppiatoBusy(statoMezzo)) {
        return true;
    }

    for (const squadra of squadreComposizione) {
        if (squadraComposizionePreaccoppiatoBusy(squadra.stato)) {
            return true;
        }
    }
    return false;
