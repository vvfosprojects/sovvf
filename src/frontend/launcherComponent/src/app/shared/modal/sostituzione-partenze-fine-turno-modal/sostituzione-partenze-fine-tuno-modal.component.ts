...
export class SostituzionePartenzeFineTunoModalComponent implements OnInit, OnDestroy {
  ...
  onListaSquadrePartenzaMontante(): void {
    const listaSquadre = {} as ListaSquadre;
    listaSquadre.idPartenza = this.partenzaMontante.id;
    listaSquadre.squadre = this.partenzaMontante.squadre;
    this.store.dispatch(new VisualizzaListaSquadrePartenza(this.partenzaMontante.mezzo.codice, listaSquadre, this.partenzaMontante.mezzo.sigla, this.partenzaMontante.mezzo.descrizione));
  }
