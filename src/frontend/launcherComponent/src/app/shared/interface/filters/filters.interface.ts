...
export interface FiltersInterface extends FiltersRichieste, FiltersSchedeContatto, FiltersGestioneUtenti, FiltersMezziInServizio, FiltersTipologiaRichiesta, FiltersDettagliTipologie, StatoRubricaPersonale, TipoRubricaPersonale {
    search: string;
    others?: VoceFiltro[];
}
