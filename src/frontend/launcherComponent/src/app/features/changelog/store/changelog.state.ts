...
export const ChangelogStateDefaults: ChangelogStateModel = {
        listaChangelog: [
            {
                nomeVersione: 'Versione del 25 Marzo 2021',
                dataRilascio: '25/03/2021 13:00',
                capitoli: [
                    {
                        titolo: 'Rilascio Versione di Test',
                        descrizioni: [
                            {
                                testo: 'È stata rilasciata una nuova versione di Test'
                            }
                        ]
                    }
                ]
            },
            {
                ...
                capitoli: [
                    {
                        titolo: 'Rilascio Versione Demo',
                        descrizioni: [
                            {
                                testo: 'È stata rilasciata una nuova versione Demo'
                            }
                        ]
                    }
                ]
                ...
                capitoli: [
                    {
                        ...
                        descrizioni: [
                            {
                                testo:
                                    'Nella barra di navigazione è stata aggiunta la possibilità di consultare la rubrica del comando di appartenenza. Per poter consultare la rubrica basta premere il quarto tasto posto nella barra di navigazione.',
                                img:
                                    '../../../../assets/changelog/ottobre/NuovaBarraNavigazione.png'
                            },
                            {
                                testo:
                                ...
                                img:
                                    '../../../../assets/changelog/ottobre/Rubrica.png'
                            },
                            {
                            ...
                            {
                                testo:
                                    'Per modificare una voce presente basta premere sul tasto giallo alla sinistra della voce da modificare e comparirà la modale di seguito con i campi già precompilati e dove sarà quindi possibile modificare quello che si desidera.',
                                img:
                                    '../../../../assets/changelog/ottobre/ModificaRubrica.png'
                            },
                            {
                    ...
                    },
                    {
                        ...
                        descrizioni: [
                            ...
                            {
                                testo:
                                    'In inserimento o modifica di una chiamata è possibile selezionare un ente tra quelli già presenti in rubrica, basta iniziare a scriverlo ed il sistema troverà l’ente desiderato, oppure, qualora l’ente non sia presente in rubrica, premendo il tasto “Nuovo Ente” è possibile aggiungerlo in rubrica ed inserirlo nella richiesta.',
                                img:
                                    '../../../../assets/changelog/ottobre/EntiIntervenutiDaModifica.png'
                            },
                            {
                                testo:
                                    'È stata aggiunta la possibilità di inserire l’ente anche direttamente dalla lista delle Richieste. Infatti, premendo sul tasto “Gestisci” su una richiesta si attiverà il tasto di seguito riportato',
                                img:
                                    '../../../../assets/changelog/ottobre/AggiuntaRapidaEnte.png'
                            },
                            {
                    ...
                    },
                    {
                        ...
                        descrizioni: [
                            {
                                testo:
                                    'È stata aggiunta la possibilità di inserire il fonogramma della richiesta. È possibile aggiungere il fonogramma direttamente dall’elenco delle richieste. Basta premere sul tasto “Gestisci“ su una richiesta e si attiverà il tasto di modifica vicino al fonogramma',
                                img:
                                    '../../../../assets/changelog/ottobre/AggiuntaRapidaFonogramma.png'
                            },
                            {
                    ...
                    },
                    {
                        ...
                        descrizioni: [
                            ...
                            {
                                testo:
                                    'La sede traferente potrà comunque consultare uno storico delle richieste trasferite tramite un’apposita funzionalità posta in alto nella barra di navigazione. È la terza icona da sinistra.',
                                img:
                                    '../../../../assets/changelog/ottobre/NuovaBarraNavigazione.png'
                            },
                            {
                    ...
                    },
                    {
                        ...
                        descrizioni: [
                            ...
                            {
                                testo:
                                    'A questo punto possiamo scegliere di salvare le modifiche o aggiungere, alla nuova partenza, degli stati che eventualmente sono stati già eseguiti ( Es. Mettere la partenza già in viaggio indicandone l’orario) premendo sui tasti appositi.',
                                img:
                                    '../../../../assets/changelog/ottobre/SequenzaEventi.png'
                            }
                        ]
                    },
                    {
                        ...
                        descrizioni: [
                            ...
                            {
                                testo:
                                    'Premendola si potrà aggiungere uno o più stati alla partenza selezionata ed indicare per ogni stato l’orario corrispondente. Premendo poi sul tasto conferma, gli inserimenti verranno salvati.',
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        descrizioni: [
                            {
                                testo:
                                    'Nella prima versione di SO115Web, quando si componeva una partenza, il sistema faceva vedere sulla mappa solo i mezzi appartenenti al comando nel quale si stava creando la partenza.'
                            },
                            {
