...
export class MapsComponent implements OnInit {
    ...
    ngOnInit() {
         ...
         */
        this.centroManager.getCentro().subscribe((r: CentroMappa) => {
            this.centroMappa = r;
        });
         ...
         */
        this.richiesteManager.getRichiesteMarker().subscribe((r: RichiestaMarker[]) => {
         ...
         */
        this.sediManager.getSediMarker().subscribe((r: SedeMarker[]) => {
            this.sediMarkers = r;
        });
         ...
         */
        this.mezziManager.getMezziMarker().subscribe((r: MezzoMarker[]) => {
            this.mezziMarkers = r;
        });
