...
namespace SO115App.API.Models.Servizi.CQRS.Queries
{
    ...
    public interface ISintesiRichiestaAssistenzaQueryHandler<TQuery, TResult> where TQuery : ISintesiRichiestaQuery<TResult>
    {
        /// <summary>
    ...
    public interface ISintesiRichiestaQuery<TResult>
    {
    }
}
