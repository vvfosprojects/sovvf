...
namespace SO115App.API.Models.Servizi.CQRS.Queries
{
    ...
    public interface ISintesiMezziMarkerQueryHandler<TQuery, TResult> where TQuery : ISintesiMezziMarkerQuery<TResult>
    {
        /// <summary>
    ...
    public interface ISintesiMezziMarkerQuery<TResult>
    {
    }
}
