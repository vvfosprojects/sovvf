...
namespace SO115App.API.Models.Servizi.CQRS.Queries
{
    ...
    public interface ISintesiSediMarkerQueryHandler<TQuery, TResult> where TQuery : ISintesiSediMarkerQuery<TResult>
    {
        /// <summary>
    ...
    public interface ISintesiSediMarkerQuery<TResult>
    {
    }
}
