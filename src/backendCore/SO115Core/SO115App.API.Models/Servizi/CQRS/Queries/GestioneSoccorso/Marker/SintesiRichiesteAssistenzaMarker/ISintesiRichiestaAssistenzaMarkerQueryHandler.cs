...
namespace SO115App.API.Models.Servizi.CQRS.Queries
{
    ...
    public interface ISintesiRichiestaAssistenzaMarkerQueryHandler<TQuery, TResult> where TQuery : ISintesiRichiestaMarkerQuery<TResult>
    {
        /// <summary>
    ...
    public interface ISintesiRichiestaMarkerQuery<TResult>
    {
    }
}
